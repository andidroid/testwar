...
public class MicroshedSharedContainerConfiguration implements SharedContainerConfiguration {
        ...
        @Container
        public static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>(image) // "postgres:latest"
        ...
        public void startContainers() {
                ...
                Flyway flyway = Flyway.configure()
                                .dataSource("jdbc:tc:postgresql://mypostgres:5432/test", "postgres", "postgres").load();
